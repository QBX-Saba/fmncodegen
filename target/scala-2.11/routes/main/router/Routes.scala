...
class Routes extends GeneratedRouter {
  ...
  def documentation: Seq[(String, String, String)] = List(
    ("""GET""", prefix + (if(prefix.endsWith("/")) "" else "/") + """codes""", """controllers.Application.codes()"""),
    ("""GET""", prefix + (if(prefix.endsWith("/")) "" else "/") + """generate""", """controllers.Application.generate()"""),
  ...
  // @LINE:6
  private[this] lazy val controllers_Application_codes0_route: Route.ParamsExtractor = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("codes")))
  )
  private[this] lazy val controllers_Application_codes0_invoker = createInvoker(
  ...
  // @LINE:7
  private[this] lazy val controllers_Application_generate1_route: Route.ParamsExtractor = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("generate")))
  )
  private[this] lazy val controllers_Application_generate1_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:6
    case controllers_Application_codes0_route(params) =>
      call { 
        controllers_Application_codes0_invoker.call(controllers.Application.codes())
      }
  
    // @LINE:7
    case controllers_Application_generate1_route(params) =>
      call { 
        controllers_Application_generate1_invoker.call(controllers.Application.generate())
      }
